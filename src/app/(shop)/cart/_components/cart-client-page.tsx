                        ...
                        <ul className="divide-y">
                            {cart.items.map(item => (
                                <li key={item.productId} className="flex items-center gap-4 p-4">
                                    <Image 
                                        src={item.imageUrl.startsWith('http') || item.imageUrl.startsWith('data:image') ? item.imageUrl : `https://placehold.co/100x100.png`} 
                                        alt={item.name} 
                                        width={100} 
                                        height={100} 
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        />
                                        <Button variant="ghost" size="icon" onClick={() => handleQuantityChange(item.productId, 0)}>
